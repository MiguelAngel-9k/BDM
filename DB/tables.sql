...
CREATE TABLE MULTIMEDIA(
	    ID_MEDIA    BIGINT NOT NULL COMMENT 'PK DE MULTIMEDIA',
	    ID_OBJ      BIGINT NOT NULL COMMENT 'PK DE OBJETOS',
	    MEDIA_REC   MEDIUMBLOB NOT NULL COMMENT 'RECURSO MULTIMEDIA',
	    MEDIA_EXT   CHAR(3) NOT NULL COMMENT 'EXTENCION DEL RECURSO MULTIMEDIA',
	    MEDIA_PESO  INT NOT NULL COMMENT 'TAMANIO DEL RECURSO',
	    MEDIA_TIPO  CHAR(1) NOT NULL COMMENT 'IMAGEN/VIDEO',
